      ...
      <div className="flex flex-wrap justify-between items-center gap-3">
        ...
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full bg-white border border-slate-200 rounded-lg pl-9 pr-4 py-2.5 text-sm text-slate-700 placeholder-slate-400 outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-100"
          />
        </div>
        ...
        <div className="relative">
          ...
          <select
            ...
            className="bg-white border border-slate-200 rounded-lg pl-9 pr-8 py-2.5 text-sm text-slate-700 outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-100 appearance-none cursor-pointer"
          >
        ...
        {hasFilters && (
          <button
            ...
            className="flex items-center gap-1.5 text-sm text-slate-400 hover:text-red-400 whitespace-nowrap"
          >
        ...
        <div className="flex items-center gap-2 mt-3 flex-wrap">
          {filterName && (
            <span className="inline-flex items-center gap-1.5 text-xs font-medium bg-blue-50 text-blue-700 px-2.5 py-1 rounded-full ring-1 ring-blue-200">
              ...
              "{filterName}"
              <button onClick={() => setFilterName('')} className="ml-0.5 hover:text-blue-900">
          ...
          {filterPosition && (
            <span className="inline-flex items-center gap-1.5 text-xs font-medium bg-violet-50 text-violet-700 px-2.5 py-1 rounded-full ring-1 ring-violet-200">
              ...
              {filterPosition}
              <button onClick={() => setFilterPosition('')} className="ml-0.5 hover:text-violet-900">
                <i className="fa-solid fa-xmark text-[9px]" />
              </button>
            </span>
          )}
          {filterDepartment && (
            <span className="inline-flex items-center gap-1.5 text-xs font-medium bg-emerald-50 text-emerald-700 px-2.5 py-1 rounded-full ring-1 ring-emerald-200">
              ...
              {filterDepartment}
              <button onClick={() => setFilterDepartment('')} className="ml-0.5 hover:text-emerald-900">
                <i className="fa-solid fa-xmark text-[9px]" />
              </button>
            </span>
          )}
